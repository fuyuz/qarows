...
export function parseDefinitionPatch(parsed: { patch?: unknown }): DefinitionPatch {
  if (parsed.patch == null) return {};
  if (typeof parsed.patch !== "object" || Array.isArray(parsed.patch)) {
